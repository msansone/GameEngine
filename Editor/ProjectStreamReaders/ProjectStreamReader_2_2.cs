 ...
 * 
 * - Removed saving the actual bitmap and audio resource data, instead only storing a GUID and 
 *   the location on disk. This is because the project file size was becoming too large and 
 *   causing out of memory exceptions and massive slowdown. Instead it will now use a resource
 *   manager to only load the bitmaps that it currently needs to render, and disposing of them
...
namespace FiremelonEditor2
{
    ...
    public class ProjectStreamReader_2_2 : IProjectStreamReader
    {
        public ProjectStreamReader_2_2(IMapWidgetFactory mapWidgetFactory, IProjectController projectController, IBitmapUtility bitmapUtility, IProjectUtility projectUtility, INameUtility nameUtility, IUriUtility uriUtility)
        {
        ...
        private void readHeader(ProjectDto_2_2 project, BinaryReader br)
        {
            // File type.
        ...
        private void readResources(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < bitmapResourceCount_; i++)
            {
                ...
                project.Bitmaps.Add(newBitmapResource.Id, newBitmapResource);
            }
            ...
            for (int i = 0; i < audioResourceCount; i++)
            {
                ...
                project.AudioData.Add(newAudioResource.Id, newAudioResource);
            }
        }

        private void readTileSheetsAndObjects(ProjectDto_2_2 project, BinaryReader br)
        {
            // Read the tilesheets
            ...
            for (int i = 0; i < tileSheetCount; i++)
            {
                ...
                BitmapResourceDto bitmapResource = project.Bitmaps[newTileSheet.BitmapResourceId];

                bitmapResource.OwnerId = newTileSheet.Id;
                ...
                project.SceneryAnimations.Add(newTileSheet.Id, new List<SceneryAnimationDto>());
            }
            ...
            for (int i = 0; i < tileSheetCount; i++)
            {
                ...
                for (int j = 0; j < tileObjectCount; j++)
                {
                    ...
                    int tlcCols = br.ReadInt32();
                    int tlcRows = br.ReadInt32();
                    ...
                    newTileObject.TopLeftCornerColumn = tlcCols;
                    newTileObject.TopLeftCornerRow = tlcRows;
                    
                    newTileObject.AnimationId = new Guid(guidAnimationId);
            ...
            // Read the scenery animation data for each tilesheet.                
            for (int i = 0; i < tileSheetCount; i++)
            {
                TileSheetDto tileSheet = project.TileSheets[i];
                ...
                int sceneryAnimationCount = br.ReadInt32();
                ...
                for (int j = 0; j < sceneryAnimationCount; j++)
                {
                    ...
                    int framesPerSecond = br.ReadInt32();
                    
                    SceneryAnimationDto newSceneryAnimation = new SceneryAnimationDto();

                    newSceneryAnimation.Id = new Guid(guidId);

                    newSceneryAnimation.OwnerId = new Guid(guidOwnerId);

                    newSceneryAnimation.RootOwnerId = new Guid(guidRootOwnerId);

                    newSceneryAnimation.Name = name;

                    newSceneryAnimation.FramesPerSecond = framesPerSecond;


                    if (dictNames.ContainsKey(newSceneryAnimation.OwnerId) == false)
                    {
                        dictNames.Add(newSceneryAnimation.OwnerId, new List<string>());
                    }

                    dictNames[newSceneryAnimation.OwnerId].Add(newSceneryAnimation.Name);


                    project.SceneryAnimations[tileSheetId].Add(newSceneryAnimation);
                }
            }
        ...
        private void readSpriteSheets(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < spriteSheetCount; i++)
            {
                ...
                BitmapResourceDto bitmapResource = project.Bitmaps[newSpriteSheet.BitmapResourceId];

                bitmapResource.OwnerId = newSpriteSheet.Id;
                ...
                newSpriteSheet.Padding = padding;
        ...
        private void readAudioAssets(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < audioCount; i++)
            {
                ...
                AudioResourceDto audioResource = project.AudioData[newAudioAsset.AudioResourceId];

                audioResource.OwnerId = newAudioAsset.Id;
        ...
        private void readLoadingScreens(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readTransitions(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readParticleEmitters(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readParticles(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readActors(ProjectDto_2_2 project, BinaryReader br)
        {
            // Read the actor data.
            ...
            for (int i = 0; i < actorCount; i++)
            {
                ...
                newActor.StageBackgroundDepth = br.ReadInt32();
        ...
        private void readEvents(ProjectDto_2_2 project, BinaryReader br)
        {
            // Read the event data.
        ...
        private void readHudElements(ProjectDto_2_2 project, BinaryReader br)
        {
            // Read the HUD data.
            ...
            for (int i = 0; i < hudElementCount; i++)
            {
                ...
                newHudElement.StageBackgroundDepth = br.ReadInt32();
        ...
        private void readSpawnPoints(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readAnimations(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readStates(ProjectDto_2_2 project, BinaryReader br)
        {
            // Read the state data.
        ...
        private void readFrames(ProjectDto_2_2 project, BinaryReader br)
        {
            // Read the frame data.                
        ...
        private void readTriggerSignals(ProjectDto_2_2 project, BinaryReader br)
        {
            List<string> lstNames = new List<string>();
        ...
        private void readFrameTriggers(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readActionPoints(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readHitboxIdentities(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readHitboxes(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < hitboxListCount; i++)
            {
                ...
                for (int j = 0; j < hitboxCount; j++)
                {
                    ...
                    newHitbox.RotationDegrees = br.ReadSingle();
        ...
        private void readAnimationSlots(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < animationSlotListCount; i++)
            {
                ...
                for (int j = 0; j < animationSlotCount; j++)
                {
                    ...
                    newAnimationSlot.Background = br.ReadBoolean();
                    ...
                    newAnimationSlot.BlendColor.Red = br.ReadSingle();
                    newAnimationSlot.BlendColor.Green = br.ReadSingle();
                    newAnimationSlot.BlendColor.Blue = br.ReadSingle();
                    newAnimationSlot.BlendColor.Alpha = br.ReadSingle();

                    newAnimationSlot.BlendPercent = br.ReadSingle();
                    ...
                    byte[] guidNextStateId = br.ReadBytes(16);
                    newAnimationSlot.NextStateId = new Guid(guidNextStateId);

                    newAnimationSlot.AnimationStyle = (AnimationStyle)br.ReadInt32();
                    newAnimationSlot.UpdateInterval = br.ReadSingle();

                    if (newAnimationSlot.UpdateInterval == 0)
                    {
                        newAnimationSlot.FramesPerSecond = 0;
                    }
                    else
                    {
                        newAnimationSlot.FramesPerSecond = Convert.ToInt32(Math.Round(1 / newAnimationSlot.UpdateInterval));
                    }

                    newAnimationSlot.OutlineColor.Red = br.ReadSingle();
                    newAnimationSlot.OutlineColor.Green = br.ReadSingle();
                    newAnimationSlot.OutlineColor.Blue = br.ReadSingle();
                    newAnimationSlot.OutlineColor.Alpha = br.ReadSingle();                    
                }
            }
        }

        private void readProperties(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readGameButtons(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readGameButtonGroups(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readUiWidgets(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readScripts(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readDataFiles(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void readRooms(ProjectDto_2_2 project, BinaryReader br)
        {
            // Read the room data.
        ...
        private void readLayers(ProjectDto_2_2 project, BinaryReader br)
        {
            // Read the layer data
        ...
        private void readSpawnPointWidgets(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < spawnPointInstanceCount; i++)
            {
                ...
                newSpawnPointWidget.Position.X = x;
                newSpawnPointWidget.Position.Y = y;
        ...
        private void readParticleEmitterWidgets(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < particleEmitterInstanceCount; i++)
            {
                ...
                newParticleEmitterWidget.Position.X = x;
                newParticleEmitterWidget.Position.Y = y;
                ...
                int animationFramesPerSecond = br.ReadInt32();
                newParticleEmitterWidget.AnimationFramesPerSecond = animationFramesPerSecond;
        ...
        private void readAudioSourceWidgets(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < audioSourceInstanceCount; i++)
            {
                ...
                newAudioSourceWidget.Position.X = x;
                newAudioSourceWidget.Position.Y = y;
        ...
        private void readWorldGeometryWidgets(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < worldGeometryChunkCount; i++)
            {
                ...
                newWorldGeometryChunkWidget.Position.X = x;
                newWorldGeometryChunkWidget.Position.Y = y;
                ...
                if (projectUtility_ != null)
                {
                    projectUtility_.AddMapWidgetToGrid(newWorldGeometryChunkWidget, (ProjectDto)project);
                }
        ...
        private void readTileObjectWidgets(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < tileObjectWidgetCount; i++)
            {
                ...
                newTileObjectWidget.Position.X = x;
                newTileObjectWidget.Position.Y = y;
        ...
        private void readEventWidgets(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < eventWidgetCount; i++)
            {
                ...
                newEventWidget.Position.X = x;
                newEventWidget.Position.Y = y;
        ...
        private void readActorWidgets(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < actorWidgetCount; i++)
            {
                ...
                newActorWidget.Position.X = x;
                newActorWidget.Position.Y = y;
        ...
        private void readHudElementWidgets(ProjectDto_2_2 project, BinaryReader br)
        {
            ...
            for (int i = 0; i < hudElementWidgetCount; i++)
            {
                ...
                newHudElementWidget.Position.X = x;
                newHudElementWidget.Position.Y = y;
        ...
        private void readWidgetProperties(ProjectDto_2_2 project, BinaryReader br)
        {
        ...
        private void setAbsolutePaths(ProjectDto_2_2 project)
        {
            if (uriUtility_ != null)
            {
                ...
                foreach (KeyValuePair<Guid, BitmapResourceDto> bitmap in project.Bitmaps)
                {
                    bitmap.Value.Path = uriUtility_.GetFullPath(bitmap.Value.RelativePath);
                }

                foreach (KeyValuePair<Guid, AudioResourceDto> audio in project.AudioData)
                {
