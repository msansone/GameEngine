...
{
    public partial class RoomListForm : Form, IRoomListForm
    {
        ...
        private IRoomListControl roomListControl_;

        public RoomListForm(IProjectController projectController, INameValidator nameValidator)
        {
            InitializeComponent();

            firemelonEditorFactory_ = new FiremelonEditorFactory();

            roomListControl_ = firemelonEditorFactory_.NewRoomListControl(projectController, nameValidator);

            //roomListControl_.MenuOpening += new MenuOpeningHandler(this.RoomListForm_MenuOpening);
            //roomListControl_.MenuClosed += new MenuClosedHandler(this.RoomListForm_MenuClosed);

            pnInnerFrame.Controls.Add((System.Windows.Forms.Control)roomListControl_);
        ...
        private void RoomListForm_MenuOpening(object sender, MenuOpeningEventArgs e)
        {
            Globals.waitForMenuClose = true;
        }

        private void RoomListForm_MenuClosed(object sender, MenuClosedEventArgs e)
        {
        ...
        public IRoomListControl RoomListControl
        {
            get
            {
                return roomListControl_;
            }
        }
        ...
        private void RoomListForm_MouseLeave(object sender, EventArgs e)
        {

        }

        private void RoomListForm_KeyPress(object sender, KeyPressEventArgs e)
        {
        }
        ...
        {
            roomListControl_.Top = -1;
            roomListControl_.Left = -1;
            roomListControl_.Height = pnInnerFrame.ClientSize.Height + 2;
            roomListControl_.Width = pnInnerFrame.ClientSize.Width + 2;
        }
        ...
        private void pnCaption_Paint(object sender, PaintEventArgs e)
        {
            ...
            g.DrawString("Rooms", new Font("Tahoma", 8), Brushes.Black, new Point(1, -2));
    ...
    public interface IRoomListForm
    {
        event FormHiddenHandler FormHidden;

        IRoomListControl RoomListControl { get; }
