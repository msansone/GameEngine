...
{
    class SpriteSheetCellUiTypeEditor : UITypeEditor
    {
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Sprite sheet not set in parent animation.");
                    return null;
                }
                else
                {
                    SpriteSheetDto spriteSheet = frame.ProjectController.GetSpriteSheet(animation.SpriteSheet);
