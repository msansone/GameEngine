...
{
    public class MapWidgetSelectorDto
    {
        ...
        private HashSet<Guid> selectedMapWidgetIds_ = new HashSet<Guid>();
        public HashSet<Guid> SelectedMapWidgetIds
        {
            get { return selectedMapWidgetIds_; }
        }
