...
{
    public partial class PropertyGridForm : Form, IPropertyGridForm
    {
        ...
        public PropertyGridForm(IProjectController projectController)
        {
            InitializeComponent();
        ...
        private void PropertyGridForm_Resize(object sender, EventArgs e)
        {
            pnFrame.Top = 0;
            pnFrame.Left = 0;
        ...
        {
            //tilesetControl_.Top = -1;
            //tilesetControl_.Left = -1;
            //tilesetControl_.Height = pnInnerFrame.ClientSize.Height + 2;
            //tilesetControl_.Width = pnInnerFrame.ClientSize.Width + 2;
        }
        ...
        private void pnCaption_Paint(object sender, PaintEventArgs e)
        {
            ...
            g.DrawString("Properties", new Font("Tahoma", 8), Brushes.Black, new Point(1, -2));
    ...
    public interface IPropertyGridForm
    {
